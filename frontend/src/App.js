...
const AppContent = () => {
  ...
  useEffect(() => {
    // Try to get the current user if a token exists
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <Switch>
        ...
        <ProtectedRoute exact path="/book" component={AppointmentBooking} />
        <ProtectedRoute exact path="/appointments" component={AppointmentList} />
        <Route exact path="/">
          <div className="min-h-screen bg-gray-50">
